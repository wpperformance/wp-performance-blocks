<div class="wpp-links-credit alignwide">
	<p class="flex flex-wrap items-center justify-center gap-6 p-0 mt-6 mb-0
  text-sm">
		<a class="flex items-center no-underline" target=" _blank" rel="noopener noreferrer" href="https://github.com/WP-Performance/wp-performance-theme">
			<svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2
      text-gray-500" width="32" height="32" viewBox="0 0 24 24">
